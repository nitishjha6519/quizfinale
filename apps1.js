...
const scoreDisplay_el = document.getElementById("scoreDisplay");
...
const displayDate_el = document.getElementById("displayDate");
var date;
function My_Date() {
   date = date_el.value;
   displayDate.textContent = date;
   console.log(date);
   var URL="https://docs.google.com/spreadsheets/d/1b_J8FCA71g5wEeHBhfhMujSc2Ak31szoerMgvogGUS8/gviz/tq?&sheet=sheet1&tq=SELECT B,C,D,E,F,G where A contains ";
  var q1=`${date}`;
  // var q1="2021-11-20";
   const endPoint = `${URL}"${q1}"`;
   ...
   .then(function (data) {
      ...
      btn.addEventListener("click", function () {
         ...
         if (q < rowslength) {
            ...
            scoreDisplay_el.textContent = `your score is ${score} out of  ${rowslength} questions `;
            console.log("finish");
...
// const q1 = `/gviz/tq?&sheet=sheet1&tq=SELECT B,C,D,E,F,G where A contains ${date}`;
...
// const endPoint = `${url}${ssid}${q1}`;
 ...
 //const endPoint="https://docs.google.com/spreadsheets/d/1b_J8FCA71g5wEeHBhfhMujSc2Ak31szoerMgvogGUS8/gviz/tq?&sheet=sheet1&tq=SELECT B,C,D,E,F,G where A contains " + date;
